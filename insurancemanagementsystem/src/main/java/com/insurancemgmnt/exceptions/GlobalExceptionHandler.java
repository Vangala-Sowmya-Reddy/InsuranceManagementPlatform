...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<Map<String,List<String>>> handleNotFoundException(ClientNotFoundException e)
	{
	...
	public ResponseEntity<Map<String,List<String>>> NotFoundException(ClaimNotFoundException e)
	{
		List<String> errors=Collections.singletonList(e.getMessage());
		return new ResponseEntity<>(getErrorMap(errors),new HttpHeaders(),HttpStatus.NOT_FOUND);
	}
	...
	public ResponseEntity<Map<String,List<String>>> NotFoundException(InsurancePolicyNotFoundException e)
	{
		List<String> errors=Collections.singletonList(e.getMessage());
		return new ResponseEntity<>(getErrorMap(errors),new HttpHeaders(),HttpStatus.NOT_FOUND);
	}
